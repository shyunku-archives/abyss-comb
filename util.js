    ...
    getDragonTrailTgz: async function(dataDragonVersion){
        ...
        let afterFinish = function(){
            if(!fs.existsSync(decompressPath)){
                ...
                console.log("DragonTrails raw already exists, decompress process skipped.");
                finalize();
            } 
        };
        ...
        const progressBar = new ProgressBar(`-> downloading dragontrails-${dataDragonVersion} data [:bar] :percent :etas`, {
            width: 80,
            complete: '=',
            incomplete: ' ',
            renderThrottle: 1,
